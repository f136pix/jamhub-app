...
class Api::V1::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_product" do
    assert_difference('Api::V1::Product.count') do
      post api_v1_products_url, params: { api_v1_product: { content: @api_v1_product.content, prize: @api_v1_product.prize, title: @api_v1_product.title } }
    end
  ...
  test "should update api_v1_product" do
    patch api_v1_product_url(@api_v1_product), params: { api_v1_product: { content: @api_v1_product.content, prize: @api_v1_product.prize, title: @api_v1_product.title } }
